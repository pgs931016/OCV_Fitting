...
% 
%     if (OCV_golden.OCVchg (end,1)<OCV_golden.OCVchg (1,2) % Discharge OCV
%         x_sto = -(Cap - Cap(1))/QN + x_0;
%         y_sto = (Cap - Cap(1))/QP + y_0;
%     else  % Charge OCV
%         x_sto = (Cap - Cap(1))/QN + x_0;
...
% 
%     
%    Cap = OCV_golden.OCVchg(:,1); %0.0043 fullcell
